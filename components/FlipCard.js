function FlipCard({ path, title, cardArray }) {
  return (
    <div
      id={path}
      className="flex h-auto w-screen items-center justify-center  bg-neutral-800"
    >
      <div className="inline-block gap-2 p-10">
        ...
        {cardArray ? (
                      ...
                      <div className="flex flex-wrap gap-2 p-2">
                        {card.text.map((item, i) => {
                          return (
                            <span
                              key={index + "." + i}
                              className="bg-gray-200 rounded text-black p-1"
                            >
                              {item}
                            </span>
                          );
          ...
          <div className="font-com text-2xl font-semibold text-white">
            {" "}
